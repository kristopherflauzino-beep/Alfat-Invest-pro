...
export type CoreAccount = { id: string; role: "ADMIN" | "CLIENTE"; username: string; email: string; name: string; phone?: string; passwordHash: string; planId?: string; planValue?: number; status: string; dueDate?: string; planStartedAt?: string; permissions: string[]; nameChangeCount?: number; nameChangeHistory?: string[]; [key: string]: unknown };
...
export type CoreState = { accounts: CoreAccount[]; plans: CorePlan[]; payments: unknown[]; portfolio: unknown[]; planPriceHistory: unknown[]; grahamSettings: Record<string, unknown>; fiiSettings: Record<string, unknown>; cryptoSettings: Record<string, unknown>; subscriptionRequests?: unknown[]; portfolioProfiles?: unknown[]; notifications?: unknown[]; notificationPreferences?: unknown[]; passwordResetTokens?: unknown[]; passwordResetRateEvents?: unknown[]; emailChangeTokens?: unknown[]; emailChangeRateEvents?: unknown[]; savedOpportunityFilters?: unknown[]; pendingRegistrations?: unknown[]; emailVerificationTokens?: unknown[]; emailVerificationRateEvents?: unknown[]; emailJobs?: unknown[]; reportExports?: unknown[]; reportRateEvents?: unknown[]; auditLogs: Array<Record<string, unknown>>; [key: string]: unknown };
