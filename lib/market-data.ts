...
function riskFrom(metrics: AssetMetrics, type: AssetType): RiskLevel {
  ...
  if (volatility > 28 || debt > 1.7) return "MÃ©dio";
  return "Baixo";
}
...
const seeds: Seed[] = [
  { ticker: "PETR4", name: "Petrobras PN", type: "ACAO", sector: "PetrÃ³leo e GÃ¡s", segment: "ExploraÃ§Ã£o e refino", price: 36.8, trend: 0.0012, volatility: 0.026, liquidity: 1850000000, metrics: { dividendYield: 11.2, pl: 5.1, pvp: 1.32, evEbitda: 2.8, roe: 28.4, roic: 18.1, roa: 9.4, netMargin: 21.1, ebitdaMargin: 46, revenue: 510000000000, profit: 115000000000, cagr: 8.2, debtToEquity: 0.76, freeCashFlow: 106000000000, volatility: 31, drawdown: 22 }, company: "PetrÃ³leo Brasileiro S.A.", tags: ["dividendos", "valor"] },
  { ticker: "VALE3", name: "Vale ON", type: "ACAO", sector: "Materiais BÃ¡sicos", segment: "MineraÃ§Ã£o", price: 62.4, trend: -0.0002, volatility: 0.023, liquidity: 1450000000, metrics: { dividendYield: 7.1, pl: 6.4, pvp: 1.5, evEbitda: 3.7, roe: 24.2, roic: 16.2, roa: 10.5, netMargin: 22.4, ebitdaMargin: 43, revenue: 208000000000, profit: 47000000000, cagr: 4.8, debtToEquity: 0.62, freeCashFlow: 39000000000, volatility: 28, drawdown: 25 }, company: "Vale S.A.", tags: ["exportadora", "commodities"] },
  ...
  { ticker: "ITSA4", name: "ItaÃºsa PN", type: "ACAO", sector: "Financeiro", segment: "Holding", price: 10.1, trend: 0.001, volatility: 0.015, liquidity: 270000000, metrics: { dividendYield: 7.3, pl: 7.9, pvp: 1.18, roe: 15.7, roic: 13.1, roa: 6.2, netMargin: 52, cagr: 7.4, debtToEquity: 0.38, volatility: 20, drawdown: 13 }, company: "ItaÃºsa S.A.", tags: ["holding", "dividendos"] },
  { ticker: "WEGE3", name: "WEG ON", type: "ACAO", sector: "Industrial", segment: "Motores e automaÃ§Ã£o", price: 42.5, trend: 0.0023, volatility: 0.019, liquidity: 510000000, metrics: { dividendYield: 1.6, pl: 31.5, pvp: 8.8, evEbitda: 21.4, roe: 30.5, roic: 25, roa: 16, netMargin: 18.6, ebitdaMargin: 23.5, revenue: 33500000000, profit: 6200000000, cagr: 17.5, debtToEquity: 0.22, freeCashFlow: 5200000000, volatility: 22, drawdown: 16 }, company: "WEG S.A.", tags: ["qualidade", "crescimento"] },
  { ticker: "TAEE11", name: "Taesa Unit", type: "ACAO", sector: "Utilidade PÃºblica", segment: "TransmissÃ£o de energia", price: 35.2, trend: 0.0009, volatility: 0.011, liquidity: 91000000, metrics: { dividendYield: 10.8, pl: 7.6, pvp: 2.05, roe: 25.1, roic: 13.4, roa: 8.8, netMargin: 48, cagr: 5.1, debtToEquity: 1.25, volatility: 16, drawdown: 9 }, company: "Transmissora AlianÃ§a de Energia ElÃ©trica S.A.", tags: ["renda", "defensiva"] },
  { ticker: "EGIE3", name: "Engie Brasil ON", type: "ACAO", sector: "Utilidade PÃºblica", segment: "Energia elÃ©trica", price: 40.2, trend: 0.0008, volatility: 0.012, liquidity: 115000000, metrics: { dividendYield: 6.8, pl: 10.4, pvp: 3.4, roe: 32.2, roic: 16.5, roa: 8.2, netMargin: 30, cagr: 7.3, debtToEquity: 1.55, volatility: 17, drawdown: 11 }, company: "Engie Brasil Energia S.A.", tags: ["qualidade", "defensiva"] },
  { ticker: "RENT3", name: "Localiza ON", type: "ACAO", sector: "Consumo CÃ­clico", segment: "Aluguel de carros", price: 50.7, trend: 0.0015, volatility: 0.027, liquidity: 420000000, metrics: { dividendYield: 2.1, pl: 20.2, pvp: 2.15, evEbitda: 8.5, roe: 12.8, roic: 9.3, roa: 5.1, netMargin: 12.7, cagr: 14, debtToEquity: 2.05, volatility: 34, drawdown: 31 }, company: "Localiza Rent a Car S.A.", tags: ["crescimento"] },
  { ticker: "ABEV3", name: "Ambev ON", type: "ACAO", sector: "Consumo NÃ£o CÃ­clico", segment: "Bebidas", price: 12.7, trend: 0.0003, volatility: 0.013, liquidity: 320000000, metrics: { dividendYield: 5.2, pl: 14.1, pvp: 2.25, roe: 16.7, roic: 14.6, roa: 10.1, netMargin: 18.2, cagr: 3.1, debtToEquity: 0.11, volatility: 17, drawdown: 14 }, company: "Ambev S.A.", tags: ["defensiva"] },
  ...
  { ticker: "PRIO3", name: "PRIO ON", type: "ACAO", sector: "PetrÃ³leo e GÃ¡s", segment: "ExploraÃ§Ã£o", price: 48.4, trend: 0.0026, volatility: 0.033, liquidity: 710000000, metrics: { dividendYield: 0, pl: 9.9, pvp: 3.1, evEbitda: 5.8, roe: 31.2, roic: 23, roa: 14, netMargin: 34, cagr: 29, debtToEquity: 0.65, volatility: 39, drawdown: 30 }, company: "PRIO S.A.", tags: ["crescimento", "petrÃ³leo"] },
  { ticker: "RADL3", name: "Raia Drogasil ON", type: "ACAO", sector: "SaÃºde", segment: "FarmÃ¡cias", price: 24.6, trend: 0.0011, volatility: 0.016, liquidity: 230000000, metrics: { dividendYield: 1.3, pl: 35, pvp: 5.8, roe: 17.4, roic: 13.8, roa: 8.1, netMargin: 3.9, cagr: 15, debtToEquity: 0.35, volatility: 21, drawdown: 16 }, company: "Raia Drogasil S.A.", tags: ["saÃºde", "crescimento"] },

  { ticker: "MXRF11", name: "Maxi Renda FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Papel", price: 10.3, trend: 0.0002, volatility: 0.007, liquidity: 64000000, metrics: { dividendYield: 12.4, pvp: 1.01, vacancyPhysical: 0, vacancyFinancial: 0, properties: 0, patrimony: 2800000000, shareholders: 1050000, volatility: 10, drawdown: 6 }, manager: "XP Asset", administrator: "BTG Pactual", tags: ["renda", "papel"] },
  { ticker: "GARE11", name: "Guardian Real Estate FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Renda Urbana", price: 9.82, trend: 0.0006, volatility: 0.009, liquidity: 18500000, metrics: { dividendYield: 11.6, pvp: 0.93, vacancyPhysical: 1.8, vacancyFinancial: 0.9, properties: 18, patrimony: 1250000000, shareholders: 185000, volatility: 13, drawdown: 8 }, manager: "Guardian Gestora", administrator: "Banco Daycoval", tags: ["renda urbana", "varejo", "renda"] },
  { ticker: "HGLG11", name: "CSHG LogÃ­stica FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "LogÃ­stica", price: 162.2, trend: 0.0007, volatility: 0.01, liquidity: 52000000, metrics: { dividendYield: 8.6, pvp: 1.05, vacancyPhysical: 3.2, vacancyFinancial: 2.8, properties: 25, patrimony: 5400000000, shareholders: 390000, volatility: 12, drawdown: 8 }, manager: "Credit Suisse Hedging-Griffo", administrator: "Credit Suisse", tags: ["logÃ­stica", "qualidade"] },
  { ticker: "XPML11", name: "XP Malls FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Shopping", price: 115.4, trend: 0.0008, volatility: 0.012, liquidity: 36000000, metrics: { dividendYield: 9.3, pvp: 0.99, vacancyPhysical: 4.1, vacancyFinancial: 3.7, properties: 15, patrimony: 3100000000, shareholders: 312000, volatility: 15, drawdown: 12 }, manager: "XP Asset", administrator: "BTG Pactual", tags: ["shopping", "renda"] },
  { ticker: "KNRI11", name: "Kinea Renda ImobiliÃ¡ria FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "HÃ­brido", price: 156.8, trend: 0.0004, volatility: 0.009, liquidity: 41000000, metrics: { dividendYield: 8.1, pvp: 0.96, vacancyPhysical: 5.4, vacancyFinancial: 4.2, properties: 20, patrimony: 4200000000, shareholders: 285000, volatility: 11, drawdown: 8 }, manager: "Kinea", administrator: "Intrag", tags: ["hÃ­brido", "renda"] },
  { ticker: "BTLG11", name: "BTG Pactual LogÃ­stica FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "LogÃ­stica", price: 101.6, trend: 0.0005, volatility: 0.011, liquidity: 29000000, metrics: { dividendYield: 9.1, pvp: 0.98, vacancyPhysical: 2.7, vacancyFinancial: 2.2, properties: 29, patrimony: 3700000000, shareholders: 245000, volatility: 12, drawdown: 7 }, manager: "BTG Pactual", administrator: "BTG Pactual", tags: ["logÃ­stica"] },
  { ticker: "VISC11", name: "Vinci Shopping Centers FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Shopping", price: 106.9, trend: 0.0006, volatility: 0.012, liquidity: 24000000, metrics: { dividendYield: 9.5, pvp: 0.94, vacancyPhysical: 4.8, vacancyFinancial: 3.5, properties: 22, patrimony: 2600000000, shareholders: 225000, volatility: 14, drawdown: 11 }, manager: "Vinci Partners", administrator: "BRL Trust", tags: ["shopping"] },
  { ticker: "KNCR11", name: "Kinea Rendimentos ImobiliÃ¡rios FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Papel", price: 102.1, trend: 0.0001, volatility: 0.006, liquidity: 46000000, metrics: { dividendYield: 11.1, pvp: 1.01, vacancyPhysical: 0, vacancyFinancial: 0, properties: 0, patrimony: 7600000000, shareholders: 370000, volatility: 8, drawdown: 5 }, manager: "Kinea", administrator: "Intrag", tags: ["papel", "renda"] },
  { ticker: "CPTS11", name: "CapitÃ¢nia Securities II FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Papel", price: 8.2, trend: 0.0001, volatility: 0.009, liquidity: 16000000, metrics: { dividendYield: 12.8, pvp: 0.91, patrimony: 2200000000, shareholders: 245000, volatility: 15, drawdown: 12 }, manager: "CapitÃ¢nia", administrator: "BTG Pactual", tags: ["papel", "alto dy"] },
  { ticker: "RBRR11", name: "RBR Rendimentos High Grade FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Papel", price: 91.7, trend: 0.0002, volatility: 0.008, liquidity: 13500000, metrics: { dividendYield: 11.7, pvp: 0.96, patrimony: 1550000000, shareholders: 135000, volatility: 13, drawdown: 9 }, manager: "RBR Asset", administrator: "BRL Trust", tags: ["papel"] },
  { ticker: "RZTR11", name: "Riza Terrax FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Agro", price: 87.4, trend: 0.0003, volatility: 0.013, liquidity: 9500000, metrics: { dividendYield: 11.9, pvp: 0.86, vacancyPhysical: 0, vacancyFinancial: 0, properties: 72, patrimony: 1350000000, shareholders: 85000, volatility: 18, drawdown: 15 }, manager: "Riza Asset", administrator: "Banco Genial", tags: ["agro", "renda"] },
  { ticker: "TRXF11", name: "TRX Real Estate FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Renda Urbana", price: 104.8, trend: 0.0008, volatility: 0.011, liquidity: 14500000, metrics: { dividendYield: 10.2, pvp: 1.03, vacancyPhysical: 0.4, vacancyFinancial: 0.1, properties: 54, patrimony: 2100000000, shareholders: 150000, volatility: 14, drawdown: 10 }, manager: "TRX", administrator: "BRL Trust", tags: ["renda urbana"] },
  { ticker: "ALZR11", name: "Alianza Trust Renda ImobiliÃ¡ria FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Renda Urbana", price: 109.3, trend: 0.0005, volatility: 0.009, liquidity: 12500000, metrics: { dividendYield: 8.4, pvp: 1.0, vacancyPhysical: 0.8, vacancyFinancial: 0.4, properties: 21, patrimony: 1200000000, shareholders: 115000, volatility: 12, drawdown: 7 }, manager: "Alianza", administrator: "BTG Pactual", tags: ["renda urbana"] },
  { ticker: "HGRU11", name: "CSHG Renda Urbana FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Renda Urbana", price: 123.7, trend: 0.0005, volatility: 0.009, liquidity: 26500000, metrics: { dividendYield: 8.9, pvp: 1.02, vacancyPhysical: 1.1, vacancyFinancial: 0.7, properties: 28, patrimony: 2700000000, shareholders: 225000, volatility: 12, drawdown: 7 }, manager: "Credit Suisse Hedging-Griffo", administrator: "Credit Suisse", tags: ["renda urbana"] },
  { ticker: "MALL11", name: "Malls Brasil Plural FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Shopping", price: 112.1, trend: 0.0004, volatility: 0.012, liquidity: 9400000, metrics: { dividendYield: 8.7, pvp: 0.92, vacancyPhysical: 4.6, vacancyFinancial: 3.9, properties: 9, patrimony: 980000000, shareholders: 87000, volatility: 15, drawdown: 12 }, manager: "Genial", administrator: "Banco Genial", tags: ["shopping"] },
  { ticker: "PVBI11", name: "VBI Prime Properties FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Lajes Corporativas", price: 79.6, trend: 0.0001, volatility: 0.014, liquidity: 9900000, metrics: { dividendYield: 9.0, pvp: 0.82, vacancyPhysical: 7.8, vacancyFinancial: 6.9, properties: 5, patrimony: 1500000000, shareholders: 75000, volatility: 18, drawdown: 17 }, manager: "VBI Real Estate", administrator: "BTG Pactual", tags: ["lajes", "desconto"] },
  { ticker: "HGRE11", name: "CSHG Real Estate FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Lajes Corporativas", price: 117.6, trend: -0.0001, volatility: 0.015, liquidity: 9800000, metrics: { dividendYield: 8.8, pvp: 0.78, vacancyPhysical: 15.2, vacancyFinancial: 11.1, properties: 17, patrimony: 1800000000, shareholders: 92000, volatility: 19, drawdown: 18 }, manager: "Credit Suisse Hedging-Griffo", administrator: "Credit Suisse", tags: ["lajes", "risco"] },
  { ticker: "XPLG11", name: "XP Log FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "LogÃ­stica", price: 102.8, trend: 0.0004, volatility: 0.011, liquidity: 21000000, metrics: { dividendYield: 8.5, pvp: 0.91, vacancyPhysical: 4.9, vacancyFinancial: 3.7, properties: 19, patrimony: 3100000000, shareholders: 170000, volatility: 14, drawdown: 11 }, manager: "XP Asset", administrator: "BTG Pactual", tags: ["logÃ­stica"] },
  { ticker: "VGIR11", name: "Valora RE III FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Papel", price: 9.6, trend: 0.0001, volatility: 0.008, liquidity: 7600000, metrics: { dividendYield: 12.2, pvp: 0.98, patrimony: 1100000000, shareholders: 118000, volatility: 14, drawdown: 9 }, manager: "Valora", administrator: "BTG Pactual", tags: ["papel"] },
  { ticker: "KNSC11", name: "Kinea Securities FII", type: "FII", sector: "Fundos ImobiliÃ¡rios", segment: "Papel", price: 9.1, trend: 0.0002, volatility: 0.008, liquidity: 9200000, metrics: { dividendYield: 12.0, pvp: 0.97, patrimony: 1250000000, shareholders: 142000, volatility: 13, drawdown: 8 }, manager: "Kinea", administrator: "Intrag", tags: ["papel"] },

  { ticker: "BOVA11", name: "iShares Ibovespa ETF", type: "ETF", sector: "Ãndices", segment: "Ibovespa", price: 125.4, trend: 0.0007, volatility: 0.014, liquidity: 280000000, metrics: { dividendYield: 2.1, pvp: 1, volatility: 18, drawdown: 14, cagr: 8 }, manager: "BlackRock", tags: ["Ã­ndice", "brasil"] },
  { ticker: "IVVB11", name: "iShares S&P 500 ETF", type: "ETF", sector: "Ãndices", segment: "S&P 500", price: 345.5, trend: 0.0015, volatility: 0.015, liquidity: 165000000, metrics: { dividendYield: 1.2, pvp: 1, volatility: 20, drawdown: 16, cagr: 13 }, manager: "BlackRock", tags: ["exterior", "dÃ³lar"] },
  { ticker: "SMAL11", name: "iShares Small Cap ETF", type: "ETF", sector: "Ãndices", segment: "Small Caps", price: 103.8, trend: 0.0005, volatility: 0.021, liquidity: 38000000, metrics: { dividendYield: 1.7, pvp: 1, volatility: 28, drawdown: 24, cagr: 7 }, manager: "BlackRock", tags: ["small caps"] },
  { ticker: "HASH11", name: "Hashdex Nasdaq Crypto ETF", type: "ETF", sector: "Ãndices", segment: "Cripto ETF", price: 62.4, trend: 0.0024, volatility: 0.035, liquidity: 48000000, metrics: { dividendYield: 0, pvp: 1, volatility: 49, drawdown: 42, cagr: 24 }, manager: "Hashdex", tags: ["cripto", "volÃ¡til"] },

  { ticker: "AAPL34", name: "Apple BDR", type: "BDR", sector: "Tecnologia", segment: "Hardware e serviÃ§os", price: 53.6, trend: 0.0014, volatility: 0.018, liquidity: 35000000, metrics: { dividendYield: 0.6, pl: 28, pvp: 34, roe: 154, roic: 48, netMargin: 26, cagr: 9, debtToEquity: 1.4, volatility: 25, drawdown: 18, marketCap: 3000000000000 }, company: "Apple Inc.", tags: ["tecnologia", "eua"] },
...
export function createGeneratedAsset(tickerInput: string): Asset {
  ...
  const asset: Asset = {
    ...
    manager: type === "FII" || type === "ETF" ? "Gestora nÃ£o informada" : undefined,
    administrator: type === "FII" ? "Administradora nÃ£o informada" : undefined,
    currency: "BRL",
    ...
    score: 0,
    risk: "MÃ©dio",
    tags: ["consulta dinÃ¢mica", typeLabels[type].toLowerCase()],
    summary: "",
    updatedAt: today,
    source: "generated"
  };
...
export function makeSummary(asset: Asset) {
  ...
  const valuation = asset.metrics.pvp ? `P/VP prÃ³ximo de ${asset.metrics.pvp}` : asset.metrics.pl ? `P/L prÃ³ximo de ${asset.metrics.pl}` : "mÃºltiplos dependentes do tipo de ativo";
  return `${asset.ticker} Ã© classificado como ${typeLabels[asset.type]} no segmento ${asset.segment}. A leitura automatizada aponta ${dy}, ${valuation}, liquidez estimada de ${asset.liquidity.toLocaleString("pt-BR")} e risco ${asset.risk.toLowerCase()}.`;
}
...
export function generateAiNotes(asset: Asset) {
  ...
  if (dy >= 10) notes.push("Perfil forte de renda: o dividend yield estÃ¡ acima da mÃ©dia usada pelo algoritmo, exigindo checagem de sustentabilidade.");
  if (pvp && pvp < 0.95) notes.push("PossÃ­vel desconto patrimonial: o P/VP estÃ¡ abaixo de 1, mas o desconto precisa ser cruzado com qualidade dos ativos e vacÃ¢ncia/endividamento.");
  if (pl && pl < 8) notes.push("Valuation aparentemente comprimido: o P/L estÃ¡ baixo em relaÃ§Ã£o ao parÃ¢metro interno do radar.");
  if (roe >= 18) notes.push("Qualidade operacional positiva: o ROE estÃ¡ em faixa considerada forte pelo modelo de score.");
  if (vol >= 40) notes.push("Risco elevado de oscilaÃ§Ã£o: a volatilidade histÃ³rica estimada exige controle de exposiÃ§Ã£o na carteira.");
  if (asset.score >= 75) notes.push("Score alto: o ativo passou bem pelos critÃ©rios combinados de valuation, qualidade, liquidez e risco.");
  if (notes.length === 0) notes.push("Ativo equilibrado: os indicadores nÃ£o dispararam alertas extremos, mas a anÃ¡lise deve ser complementada com dados atualizados e contexto setorial.");
  return notes;
}
